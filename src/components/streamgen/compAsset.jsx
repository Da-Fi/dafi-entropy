...
import dafi_theme from "../../theme/theme";
      ...
      <div className={classes.tradeContainer}>
        ...
        <div className={classes.scaleContainer}>
          <Button
            ...
            <Typography variant={'h5'} style={{fontFamily:'"Eczar"'}}>25%</Typography>
          </Button>
          <Button
            className={classes.scale}
            variant='text'
            ...
            <Typography variant={'h5'} style={{fontFamily:'"Eczar"'}}>50%</Typography>
          </Button>
          <Button
            className={classes.scale}
            variant='text'
            ...
            <Typography variant={'h5'}style={{fontFamily:'"Eczar"'}} >75%</Typography>
          </Button>
          <Button
            className={classes.scale}
            variant='text'
            ...
            <Typography variant={'h5'} style={{fontFamily:'"Eczar"'}}>100%</Typography>
          </Button>
        </div>
        <Button
          ...
          fullWidth
        >
          <Typography className={classes.buttonText} style={{fontFamily:'"Eczar"'}} variant={'h5'} color={asset.disabled? '':'secondary'}>{asset.disabled? t('Asset.Disabled'):t('Asset.Deposit')}</Typography>
        </Button>
      </div>
